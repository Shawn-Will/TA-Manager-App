...
import static djf.settings.AppPropertyType.SAVE_AS_ERROR_MESSAGE;
import static djf.settings.AppPropertyType.SAVE_AS_ERROR_TITLE;
...
public class AppFileController {
	...
	PropertiesManager props = PropertiesManager.getPropertiesManager();
		...
		// WORK IS NOT SAVED
                ...
                app.getGUI().updateToolbarControls(saveAs);
	...
	// THE APPROPRIATE CONTROLS
	app.getGUI().updateExport(export);
    }
    ...
    public void handleSaveAsRequest() {
	    ...
	    AppMessageDialogSingleton dialog = AppMessageDialogSingleton.getSingleton();
	    dialog.show(props.getProperty(SAVE_AS_ERROR_TITLE), props.getProperty(SAVE_AS_ERROR_MESSAGE));
        }
    }
}
